...
public class FeedCMD implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("feed")) {
            if (!(sender instanceof Player)) {
                ...
                SCore.debug("&fHa regenerado la comida del jugador &e" + playerName + "&f.");
                target.setFoodLevel(20);
                target.sendMessage(new Tools().Text("&fTu hambre ha sido regenerado por el servidor."));
                return true;
            } else {
                ...
                if (args.length == 0) {
                    ...
                    player.sendMessage(new Tools().Text("&eTu hambre ha sido regenerado!"));
                    ...
                    player.sendMessage(new Tools().Text("&fHa regenerado la comida del jugador &e" + playerName + "&f."));
                    target.setFoodLevel(20);
                    target.sendMessage(new Tools().Text("&fTu hambre ha sido regenerado por &e" + player.getName() + "&f."));
                    return true;
                }                
            }
        }
